...
getAnswers();
 ...
 //   var siteType = prompt("Выберите тип сайта (стереть лишнее)", "Лэндинг/Интернет- м-н/Сайт-визитка/Корп.сайт");
//        if (siteType === ''){alert("Вы не указали тип сайта");}
//            else if (siteType === "Лэндинг"){alert(lend);} 
//            else if (siteType === "Интернет- м-н"){alert(internetM);}
//            else if (siteType === "Сайт-визитка"){alert(visit);}
//            else if (siteType === "Корп.сайт"){alert(corp);}
             

//var adapt = prompt("Требуется ли адаптивность вашему сайту?", "Да/Нет");
//if (adapt === ''){alert("Вы не указали адаптивность сайта");}
//    else if (adapt === "Да"){alert(yes);}
//    else if (adapt === "Нет"){alert(no);}